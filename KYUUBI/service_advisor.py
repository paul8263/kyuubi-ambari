...
class KyuubiServiceAdvisor(service_advisor.ServiceAdvisor):

    def __init__(self, *args, **kwargs):
        self.as_super = super(KyuubiServiceAdvisor, self)
    ...
    def getServiceConfigurationRecommendations(self, configurations, clusterData, services, hosts):
        ...
        recommender = KyuubiRecommender()
        recommender.recommendKyuubiConfigurationsFromHDP30(configurations, clusterData, services, hosts)
...
class KyuubiRecommender(service_advisor.ServiceAdvisor):
    ...
    def __init__(self, *args, **kwargs):
        self.as_super = super(KyuubiRecommender, self)
        self.as_super.__init__(*args, **kwargs)

    def recommendKyuubiConfigurationsFromHDP30(self, configurations, clusterData, services, hosts):
        """
